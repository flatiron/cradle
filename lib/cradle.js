...
//      content
//
cradle.Connection.prototype.rawRequest = function (method, path, options, data, headers, callback /* for handling errors when couchdb is offline. */) {
...
cradle.Connection.prototype.request = function (method, path, /* [options], [data], [headers] */ callback) {
    ...
    request = this.rawRequest(method, path, options, data, headers, callback /* for handling errors when couchdb is offline. */);
