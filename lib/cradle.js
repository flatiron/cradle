    ...
    return {
        ...
        save: function (/* [id], [rev], doc | [doc, ...] */) {
            ...
            if (args.length === 0) {
                ...
                this.bulkDocs.reverse();
                doc = this.bulkDocs.filter(function (doc) {
                    if (doc._id) {
                        if (!uniq[doc._id]) {
                            uniq[doc._id] = true;
                            return true;
       ...
       _merge: function (id, doc, callback) {
        ...
        _push: function (id, rev, doc) {
            ...
            if (id) {
                ...
                // Push a single document to Bulk Docs queue
                this.bulkDocs.push(document);
            } else {
              // Push a single document, without an id (Create)
              this.bulkDocs.push(doc);
            }
        },
